...
datos_aero_Trelew <- read_excel("187309 - Trelew Aero (87828).xlsx")

# Primero, transformo el formato de los datos del data frame a los tipos que corresponden.

names(datos_aero_Trelew)[6] <- "vto_max_veloc" 

datos_aero_Trelew$fecha <- as.Date(datos_aero_Trelew$fecha)
datos_aero_Trelew$tmax <- as.double(datos_aero_Trelew$tmax)
datos_aero_Trelew$hr <- as.double(datos_aero_Trelew$hr)
datos_aero_Trelew$vto_max_veloc <- as.double(datos_aero_Trelew$vto_max_veloc)
...
datos_aero_Trelew <- datos_aero_Trelew %>%
  mutate(month = month(fecha))

skim_without_charts(datos_aero_Trelew)
...
hr_ridges_Trelew <- ggplot(datos_aero_Trelew) +
  ...
  labs(title = 'Distribución de Humedades relativas mensuales en Trelew',
       subtitle = "Distribución de registro de humedades relativas medias de Trelew desde 1961 a 2021",
       x = "Humedad Relativa %",
       y = "Mes") +
  theme_ridges() +
  theme(
...
vto_max_veloc_ridges_Trelew <- ggplot(datos_aero_Trelew) +
  ...
  labs(title = 'Distribución de Velocidades máximas de viento en Trelew',
       subtitle = "Distribución de registro de velocidades de viento máximas de Trelew desde 1961 a 2021",
...
tmax_ridges_Trelew <- ggplot(datos_aero_Trelew) +
  ...
  labs(title = 'Distribución de Temperaturas máximas mensuales en Trelew',
       subtitle = "Distribución de registro de temperaturas máximas de Trelew desde 1961 a 2021",
...
plot(tmax_ridges_Trelew)
plot(hr_ridges_Trelew)
plot(vto_max_veloc_ridges_Trelew)
...
datos_aero_Trelew_mensual <- datos_aero_Trelew %>%
  drop_na() %>%
  group_by(month) %>%
...
datos_aero_Trelew_simulados <- data.frame()

for (i in 1:12){
  temperaturas <- rnorm(runs, datos_aero_Trelew_mensual[[i,2]], datos_aero_Trelew_mensual[[i,3]])
  vientos <- rnorm(runs, datos_aero_Trelew_mensual[[i,6]], datos_aero_Trelew_mensual[[i,7]])
  humedades_relativas <- rnorm(runs, datos_aero_Trelew_mensual[[i,4]], datos_aero_Trelew_mensual[[i,5]])
  ...
  datos_aero_Trelew_simulados <- rbind(datos_aero_Trelew_simulados, simulaciones)
  i = i + 1
}

tasas_de_evaporacion_ridges_Trelew <- ggplot(datos_aero_Trelew_simulados) +
  ...
  labs(title = 'Distribución de tasas de evaporación mensuales en Trelew',
       subtitle = "Distribución de simulación de tasas de evaporación para Trelew a partir de datos de clima de 1961
...
plot(tasas_de_evaporacion_ridges_Trelew)

# Ahora obtendré el promedio y el desvio mensual de las distribuciones 
# definidas en la simulación.

datos_aero_Trelew_mensual_simulacion <- datos_aero_Trelew_simulados %>%
  drop_na()%>%
  group_by(mes)%>%
...
datos_aero_Trelew_mensual_simulacion <- datos_aero_Trelew_mensual_simulacion %>%
...
names(datos_aero_Trelew_mensual_simulacion)[1] <- "month"

probabilidades_mensuales_tasa_0.5_Trelew <- ggplot(datos_aero_Trelew_mensual_simulacion)+
...
plot(probabilidades_mensuales_tasa_0.5_Trelew)
...
datos_aero_Trelew_simulados_T20 <- data.frame()
...
for (i in 1:12){
  ...
  simulaciones <- data.frame(mes,
                             ...
                             humedades_relativas,
                             tasa_de_evaporacion_simulada)
  datos_aero_Trelew_simulados_T20 <- rbind(datos_aero_Trelew_simulados_T20, simulaciones)
  i = i + 1
}

datos_aero_Trelew_simulados_T25 <- data.frame()
...
for (i in 1:12){
  ...
  simulaciones <- data.frame(mes,
                             ...
                             humedades_relativas,
                             tasa_de_evaporacion_simulada)
  datos_aero_Trelew_simulados_T25 <- rbind(datos_aero_Trelew_simulados_T25, simulaciones)
  i = i + 1
}

datos_aero_Trelew_simulados_T30 <- data.frame()
...
for (i in 1:12){
  ...
  simulaciones <- data.frame(mes,
                             ...
                             humedades_relativas,
                             tasa_de_evaporacion_simulada)
  datos_aero_Trelew_simulados_T30 <- rbind(datos_aero_Trelew_simulados_T30, simulaciones)
  i = i + 1
}

datos_aero_Trelew_simulados_T35 <- data.frame()
...
for (i in 1:12){
  ...
  simulaciones <- data.frame(mes,
                             ...
                             humedades_relativas,
                             tasa_de_evaporacion_simulada)
  datos_aero_Trelew_simulados_T35 <- rbind(datos_aero_Trelew_simulados_T35, simulaciones)
  i = i + 1
}
...
datos_aero_Trelew_mensual_simulacion_T20 <- datos_aero_Trelew_simulados_T20 %>%
  drop_na()%>%
  group_by(mes)%>%
...
datos_aero_Trelew_mensual_simulacion_T25 <- datos_aero_Trelew_simulados_T25 %>%
  drop_na()%>%
  group_by(mes)%>%
...
datos_aero_Trelew_mensual_simulacion_T30 <- datos_aero_Trelew_simulados_T30 %>%
  drop_na()%>%
  group_by(mes)%>%
...
datos_aero_Trelew_mensual_simulacion_T35 <- datos_aero_Trelew_simulados_T35 %>%
  drop_na()%>%
  group_by(mes)%>%
...
names(datos_aero_Trelew_mensual_simulacion_T20)[1] <- "month"
names(datos_aero_Trelew_mensual_simulacion_T25)[1] <- "month"
names(datos_aero_Trelew_mensual_simulacion_T30)[1] <- "month"
names(datos_aero_Trelew_mensual_simulacion_T35)[1] <- "month"

# Ahora pondré todos los resultados de las simulaciones en un único Dataframe

Simulaciones_finales_Trelew <- merge(datos_aero_Trelew_mensual_simulacion, datos_aero_Trelew_mensual_simulacion_T20, by = "month")
Simulaciones_finales_Trelew <- merge(Simulaciones_finales_Trelew, datos_aero_Trelew_mensual_simulacion_T25, by = "month")
Simulaciones_finales_Trelew <- merge(Simulaciones_finales_Trelew, datos_aero_Trelew_mensual_simulacion_T30, by = "month")
Simulaciones_finales_Trelew <- merge(Simulaciones_finales_Trelew, datos_aero_Trelew_mensual_simulacion_T35, by = "month")

# Ahora realizaré el gráfico de probabilidades para todas las temperaturas
#######
#######

probabilidades_mensuales_T35_Trelew <- ggplot(Simulaciones_finales)+
...
plot(probabilidades_mensuales_T35_Trelew)

tasas_de_evaporacion_ridges_T35_Trelew <- ggplot(datos_aero_Trelew_simulados_T35) +
  geom_density_ridges_gradient(scale = 3.5,
                               rel_min_height = 0.01,
                               aes(x = tasa_de_evaporacion_simulada, y = as.factor(mes),
                                   fill = ..x..)) +
...
plot(tasas_de_evaporacion_ridges_T35_Trelew)

#######
#######

probabilidades_mensuales_T30_Trelew <- ggplot(Simulaciones_finales)+
...
plot(probabilidades_mensuales_T30_Trelew)

# position=position_dodge(width=0.9), hjust=0.75

tasas_de_evaporacion_ridges_T30_Trelew <- ggplot(datos_aero_Trelew_simulados_T30) +
  geom_density_ridges_gradient(scale = 3.5,
                               rel_min_height = 0.01,
                               aes(x = tasa_de_evaporacion_simulada, y = as.factor(mes),
                                   fill = ..x..)) +
...
plot(tasas_de_evaporacion_ridges_T30_Trelew)
